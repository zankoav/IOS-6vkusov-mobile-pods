...
class BasketTableViewController: UITableViewController{
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return basket.products[section].variants.count
    }

    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "product_cell") as! VariantTableViewCell
        let variant = basket.products[indexPath.section].variants[indexPath.row]
        cell.variant = basket.products[indexPath.section].variants[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        cell.name.text = basket.products[section].name
        cell.desc.text = basket.products[section].descriptionProduct
        cell.icon.sd_setImage(with: URL(string: basket.products[section].icon), placeholderImage: UIImage(named:"avatar"))
